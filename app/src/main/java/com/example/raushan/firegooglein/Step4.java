        ...
        bb.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(proptype.equals("Complete Apartment")) {
                    Intent i = new Intent(Step4.this,Option1.class);
                ...
                {
                    Intent i = new Intent(Step4.this,Option2.class);
                    i.putExtra("proptype2",proptype);
                    i.putExtra("cust_name2",cust_name);
                    i.putExtra("prop_name2",prop_name);
                    i.putExtra("cust_num2",cust_num);
                ...
                {
                    Intent i = new Intent(Step4.this,Option3.class);
                    i.putExtra("proptype2",proptype);
                    i.putExtra("cust_name2",cust_name);
                    i.putExtra("prop_name2",prop_name);
                    i.putExtra("cust_num2",cust_num);
                ...
                {
                    Intent i = new Intent(Step4.this,Option4.class);
                    i.putExtra("proptype2",proptype);
                    i.putExtra("cust_name2",cust_name);
                    i.putExtra("prop_name2",prop_name);
                    i.putExtra("cust_num2",cust_num);
                ...
                {
                    Intent i = new Intent(Step4.this,Option5.class);
                    i.putExtra("proptype2",proptype);
                    i.putExtra("cust_name2",cust_name);
                    i.putExtra("prop_name2",prop_name);
                    i.putExtra("cust_num2",cust_num);
